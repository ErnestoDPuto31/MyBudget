...
public class DatabaseHelper : SQLiteOpenHelper
{
    ...
    {
        db.ExecSQL($"CREATE TABLE {TABLE_EXPENSES} ({COL_ID} INTEGER PRIMARY KEY AUTOINCREMENT, {COL_DESC} TEXT, {COL_AMOUNT} REAL, {COL_CATEGORY} TEXT)");
    ...
    public List<Expense> GetAllExpenses()
    {
        ...
        SQLiteDatabase db = ReadableDatabase;
        ICursor cursor = db.RawQuery($"SELECT {COL_ID}, {COL_DESC}, {COL_AMOUNT}, {COL_CATEGORY} FROM {TABLE_EXPENSES}", null);
